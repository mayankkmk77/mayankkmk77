...
💡 Interests: Full-Stack Development (frontend + backend) and Scalable Management Systems
🌱 Currently Learning: Backend Development for Full-Stack Applications, Data Structures & Algorithms (Java)
🎯 Career Objective: Software Developer focused on building robust, scalable applications
...
🐧 Linux Monitoring Tool (C)

<p>
🔹 System monitoring tool built in C for Linux environments  
<br>
🔹 Tracks system performance metrics like CPU and memory usage  
<br>
🔹 Focus on low-level programming and efficient resource handling  
</p>☕ Java Projects

<p>
🔹 Multiple Java-based applications  
<br>
🔹 Covers OOP concepts & problem solving  
</p><p align="center">
